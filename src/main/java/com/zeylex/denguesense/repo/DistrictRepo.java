...
public interface DistrictRepo extends JpaRepository<District, Long> {
    ...
    Optional<District> findByRdhsZoneIgnoreCase(String rdhsZone);

    Optional<District> findByRdhsModelId(Integer rdhsModelId);

    List<District> findByRdhsModelIdNotNullOrderByRdhsModelIdAsc();
}
